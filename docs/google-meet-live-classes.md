...
1. An instructor opens an Airads Google Meet lesson, connects Google Calendar, and chooses **Save & create Google Meet**.
2. Confirm the unique Meet link and Calendar event appear; test invite-off and invite-on separately.
3. Publish only after the Meet status is ready. A learner verifies the countdown and joins through Airads during the join window.
