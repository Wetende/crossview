...
const getBadgeColor = (type, theme) => {
    switch (type) {
        ...
        case 'special': return theme.palette.warning.main;
            ...
            <CardContent sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', p: 2 }}>
                ...
                <Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 1.5 }}>
                    <Stack direction="row" spacing={0.5} alignItems="center">
                        ...
                        <Typography variant="caption" color="text.secondary">
                            {program.rating?.toFixed(1) || '0'} ({program.reviewCount || 0})
                        </Typography>
                    </Stack>
                    <Stack direction="row" spacing={0.5} alignItems="center">
                ...
                <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 2 }}>
                    <Stack direction="row" spacing={0.5} alignItems="center">
                        <IconCircleFilled 
                            size={10} 
                            color={isPublished ? theme.palette.success.main : theme.palette.grey[400]} 
                        />
                        <Typography variant="caption" color="text.secondary">
                    ...
                    <Stack direction="row" spacing={0.5} alignItems="center">
                        ...
                        <Typography 
                            variant="body2" 
                            fontWeight={600}
                            color={priceInfo.text === 'Free' ? 'success.main' : 'text.primary'}
                        >
                            {priceInfo.text}
                        </Typography>
                    </Stack>
