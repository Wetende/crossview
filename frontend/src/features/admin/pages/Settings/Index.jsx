...
export default function SettingsIndex({ platform, settings, subscription }) {
    ...
    const showSubscription = capabilities.showSubscription !== false;
    const canManageRegistration = capabilities.manageRegistration !== false;
    const canManageBranding = capabilities.manageBranding !== false;
    const portalHost =
        platform?.host ||
    ...
    return (
        <DashboardLayout role="admin" breadcrumbs={[{ label: "Settings" }]}>
            <Head title="Settings" />
                                        ...
                                        <Stack spacing={2}>
                                            ...
                                            <Box>
                                                ...
                                                >
                                                    ...
                                                    <Typography variant="body2">
                                                        {subscription?.currentPrograms ||
                                                            0}{" "}
                                                        /{" "}
                                                        {subscription?.maxPrograms ||
                                                            10}
                                                    </Typography>
                                                </Box>
                                                <LinearProgress
