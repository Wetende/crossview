...
export default function PresetForm({
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        hierarchyLabels: initialData.hierarchyLabels || [
            "Year",
            "Unit",
            "Session",
        ],
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const url = isEdit
            ? `/superadmin/presets/${preset.id}/edit/`
    ...
    const addLabel = () => {
        if (newLabel.trim()) {
            setData("hierarchyLabels", [
                ...data.hierarchyLabels,
                newLabel.trim(),
            ]);
            setNewLabel("");
        }
    ...
    const removeLabel = (index) => {
        setData(
            "hierarchyLabels",
            data.hierarchyLabels.filter((_, i) => i !== index),
        );
    };
    ...
    return (
        <DashboardLayout role="superadmin">
            <Head
                title={
                    isEdit ? `Edit Preset: ${preset?.name}` : "Create Preset"
                }
            />
            ...
            <Stack spacing={3}>
                <Typography variant="h4">
                    {isEdit
                        ? "Edit Preset Blueprint"
                        : "Create Preset Blueprint"}
                </Typography>
                                ...
                                <Grid container spacing={3}>
                                    ...
                                    <Grid size={{ xs: 12, md: 6 }}>
                                        <TextField
                                            ...
                                            helperText={
                                                allErrors.code ||
                                                "Unique identifier (e.g., tvet-kenya, theology-standard)"
                                            }
                                            required
                                        />
                                    </Grid>
                                    ...
                                    <Grid size={{ xs: 12 }}>
                                        ...
                                        <Typography
                                            ...
                                            gutterBottom
                                        >
                                            Define the levels of your curriculum
                                            structure (e.g., Year → Unit →
                                            Session)
                                        </Typography>
                                    ...
                                    <Grid size={{ xs: 12, md: 6 }}>
                                        <TextField
                                            ...
                                            type="number"
                                            value={
                                                data.gradingConfig.passMark ||
                                                50
                                            }
                                            onChange={(e) =>
                                                setData("gradingConfig", {
                                                    ...data.gradingConfig,
                                                    passMark:
                                                        parseInt(
                                                            e.target.value,
