    ...
    <x-slot name="header">
        ...
        <div class="breadcrumbs mt-10 pt-0 pb-0">
            <div class="breadcrumbs__content">
                ...
                <div class="breadcrumbs__item">
                    <a href="{{ route('student.messages') }}">Messages</a>
                </div>
            </div>
        </div>
    </x-slot>
    ...
    <div class="row y-gap-30">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                <div class="d-flex items-center py-20 px-30 border-bottom-light">
                    ...
                    {{-- Add a search or new message button if needed --}}
                </div>

                <div class="py-30 px-30 scroll-bar-1" style="max-height: 600px; overflow-y: auto;">
                    <div class="y-gap-30">
                        {{-- Placeholder for looping through conversations --}}
                        {{-- Example Conversation Item (Active) --}}
                        <div class="d-flex justify-between items-center cursor-pointer p-10 rounded-8 -hover-bg-light-2 {{-- Add active class: bg-light-2 -dark-bg-dark-2 --}}">
                            <div class="d-flex items-center">
                                <div class="shrink-0">
                                    <img src="{{ asset('img/avatars/small/1.png') }}" alt="image" class="size-50 rounded-full">
                                </div>
                                <div class="ml-10">
                                    <div class="lh-11 fw-500 text-dark-1">Instructor Name</div>
                                    <div class="text-14 lh-11 mt-5 text-light-1">Okay, see you then!</div>
                                </div>
                            </div>
                            <div class="d-flex items-end flex-column pt-8">
                                <div class="text-13 lh-1">15 mins</div>
                                <div class="d-flex justify-center items-center size-20 bg-purple-1 rounded-full mt-8">
                                    <span class="text-11 lh-1 text-white fw-500">2</span> {{-- Unread count --}}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-between items-center cursor-pointer p-10 rounded-8 -hover-bg-light-2">
                            <div class="d-flex items-center">
                                <div class="shrink-0">
                                    <img src="{{ asset('img/avatars/small/2.png') }}" alt="image" class="size-50 rounded-full">
                                </div>
                                <div class="ml-10">
                                    <div class="lh-11 fw-500 text-dark-1">Support Team</div>
                                    <div class="text-14 lh-11 mt-5 text-light-1">Thanks for reaching out.</div>
                                </div>
                            </div>
                            <div class="d-flex items-end flex-column pt-8">
                                <div class="text-13 lh-1">1 day ago</div>
                            </div>
                        </div>
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                ...
                <div class="d-flex flex-column justify-center items-center h-100" {{-- v-if="!selectedConversation" --}} >
                ...
                {{-- This part would be dynamically rendered based on selected conversation --}}
                <div class="d-none" {{-- v-if="selectedConversation" --}} >
                    <div class="d-flex items-center justify-between py-20 px-30 border-bottom-light">
                        <div class="d-flex items-center">
                            <div class="shrink-0">
                                <img src="{{ asset('img/avatars/small/1.png') }}" alt="image" class="size-50 rounded-full"> {{-- Contact's avatar --}}
                            </div>
                            <div class="ml-10">
                                <div class="lh-11 fw-500 text-dark-1">Instructor Name</div> {{-- Contact's name --}}
                                <div class="text-14 lh-11 mt-5 text-green-5">Active</div> {{-- Contact's status --}}
                            </div>
                        </div>
                        ...
                        <div class="row y-gap-20">
                            ...
                            <div class="col-xl-7 col-lg-10">
                                <div class="d-flex items-center">
                                    ...
                                    <div class="lh-11 fw-500 text-dark-1 ml-10">Instructor Name</div>
                                    <div class="text-14 lh-11 ml-10">15 mins ago</div>
                                </div>
                            ...
                            <div class="col-xl-7 offset-xl-5 col-lg-10 offset-lg-2">
                                <div class="d-flex items-center justify-end">
                                    <div class="text-14 lh-11 mr-10">14 mins ago</div>
                                    <div class="lh-11 fw-500 text-dark-1 mr-10">You</div>
                                    <div class="shrink-0">
                                        <img src="{{ asset('img/avatars/small/default.png') }}" alt="image" class="size-50 rounded-full"> {{-- Current user's avatar --}}
                                    </div>
                                </div>
                    ...
                    <div class="py-25 px-40 border-top-light">
                        <form action="#" method="POST" class="row y-gap-10 justify-between"> {{-- Update action --}}
                            @csrf
                            <div class="col-lg-10">
                                <input class="-dark-bg-dark-2 py-20 w-1/1" name="message" type="text" placeholder="Type a Message">
                            </div>
