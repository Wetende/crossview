            ...
            <div class="rounded-16 bg-white -dark-bg-dark-1 shadow-4 h-100">
                <div class="tabs -active-purple-2 js-tabs pt-0">
                    <div class="tabs__controls d-flex x-gap-30 items-center pt-20 px-30 border-bottom-light js-tabs-controls">
                        ...
                        {{-- Maybe Social Profiles and Close Account for students too --}}
                    ...
                    <div class="tabs__content py-30 px-30 js-tabs-content">
                        ...
                        <div class="tabs__pane -tab-item-1 is-active">
                            <div class="row y-gap-20 x-gap-20 items-center">
                                <div class="col-auto">
                                    <img class="size-100" src="{{ asset('img/dashboard/edit/1.png') }}" alt="image"> {{-- Use asset() --}}
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="border-top-light pt-30 mt-30">
                                <form action="#" class="contact-form row y-gap-30"> {{-- Update action --}}
                                    ...
                                    <div class="col-12">
                                        <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">About Me</label>
                                        <textarea name="bio" placeholder="About Me" rows="5"></textarea>
                                    </div>
                                    <div class="col-12">
                        ...
                        <div class="tabs__pane -tab-item-3">
                           <h4 class="text-18 lh-12 fw-500">Notification Settings</h4>
                           <div class="pt-20">Placeholder for notification settings. (e.g., Email me about course updates, new messages, etc.)</div>
                           {{-- Add form elements for notification preferences --}}
                        </div>
                        ...
                        <div class="tabs__pane -tab-item-4">
                            <form action="#" class="contact-form row y-gap-30"> {{-- Update action --}}
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="facebook_profile" placeholder="https://www.facebook.com/username">
                                </div>
                                <div class="col-12">
                                    <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">Twitter</label>
                                    <input type="text" name="twitter_profile" placeholder="https://www.twitter.com/username">
                                </div>
                                <div class="col-12">
                                    <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">LinkedIn</label>
                                    <input type="text" name="linkedin_profile" placeholder="https://www.linkedin.com/in/username">
                                </div>
                                <div class="col-12">
                                    <button class="button -md -purple-1 text-white">Save Social Profiles</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="tabs__pane -tab-item-5">
                            ...
                            <div class="pt-20">Closing your account is irreversible. All your data will be permanently deleted.</div>
                            <form action="#" method="POST" class="mt-20"> {{-- Update action --}}
                                @csrf
                                @method('DELETE') {{-- Or appropriate method --}}
