<x-app-layout>
                                ...
                                <div class="priceCard__content py-45 px-60 text-center">
                                        ...
                                        <div class="priceCard__price text-45 lh-11 fw-700 text-dark-1 mt-15">
                                            ...
                                            <div class="monthly-price">
                                                @if($tier->price > 0)
                                                    KES {{ number_format($tier->price, 0) }}
                                                @else
                                                    Free
                                                @endif
                                            </div>
                                            ...
                                            <div class="annual-price" style="display: none;">
                                                @if($tier->price > 0)
                                                    <div class="d-flex justify-center items-end">
                                                        <div>KES {{ number_format($tier->price * 12 * $discountMultiplier, 0) }}</div>
                                                        <div class="text-14 text-light-1 line-through ml-10">KES {{ number_format($tier->price * 12, 0) }}</div>
                                    </div>
                                                @else
                                                    Free
                                                @endif
                                    ...
                                    <div class="text-left y-gap-15 mt-35">
                                            ...
                                            <div class="annual-features" style="display: none;">
                                                @if($tier->price > 0)
                                                    ...
                                                    <div><i class="text-green-1 pr-8" data-feather="plus"></i> @lmsterm('Study Material') completion certificates</div>
                                                @endif
                                            </div>
                                    </div>
                            ...
                            <div class="pt-60 lg:pt-40 border-top-light">
                                ...
                                <div class="accordion -block mt-60 lg:mt-40 js-accordion">
                                    <div class="accordion__item">
                                        ...
                                        <div class="accordion__content">
                                            <div class="accordion__content__inner">
                                                <p>Annual plans provide a {{ (int)config('app.annual_discount', 30) }}% discount compared to paying monthly. Annual subscribers also get additional perks like priority support, exclusive webinars, and @lmsterm('Study Material') completion certificates.</p>
                                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="accordion__item">
                                        ...
                                        <div class="accordion__content">
                                            <div class="accordion__content__inner">
                                                <p>When your subscription expires, you'll retain access to any @lmsterm('Study Materials') you've completed, but access to active @lmsterm('Study Materials') will be paused until you renew your subscription.</p>
                                            </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Add event listener to the billing toggle container for better UX
            if (billingToggle) {
