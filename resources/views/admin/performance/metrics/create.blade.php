<x-dashboard-layout>
    ...
    <div class="dashboard__content bg-light-4">
        <div class="row y-gap-20 justify-between items-end pb-30 mb-10">
            <div class="col-auto">
                <h1 class="text-30 lh-12 fw-700">Add Performance Metric</h1>
                <div class="mt-10">Create a new performance metric for student evaluations</div>
            </div>
            <div class="col-auto">
        ...
        <div class="row y-gap-30">
            <div class="col-12">
                <div class="py-30 px-30 rounded-16 bg-white -dark-bg-dark-1 shadow-4">
                    ...
                    <form action="{{ route('admin.performance.metrics.store') }}" method="POST" class="row y-gap-20">
                        @csrf
                        
                        <div class="col-lg-6">
                            <label class="text-16 lh-1 fw-500 text-dark-1 mb-10" for="name">Metric Name*</label>
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="e.g., Quiz Performance">
                            @error('name')
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="key" id="key" class="form-control @error('key') is-invalid @enderror" value="{{ old('key') }}" required placeholder="e.g., quiz_performance">
                            @error('key')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" id="description" rows="4" class="form-control @error('description') is-invalid @enderror" placeholder="Detailed description of the metric">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="number" name="weight" id="weight" step="0.01" min="0" max="1" class="form-control @error('weight') is-invalid @enderror" value="{{ old('weight', '0.5') }}" required>
                            @error('weight')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-switch d-flex items-center">
                                <input type="checkbox" name="is_subject_specific" id="is_subject_specific" class="form-check-input @error('is_subject_specific') is-invalid @enderror" value="1" {{ old('is_subject_specific') ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="calculation_formula" id="calculation_formula" class="form-control @error('calculation_formula') is-invalid @enderror" value="{{ old('calculation_formula') }}" placeholder="e.g., AVG(quiz_scores)">
                        ...
                        <div class="col-12 mt-20">
                            ...
                            <div class="d-flex items-center justify-end">
                                ...
                                <button type="submit" class="button -md -purple-1 text-white">Create Metric</button>
                            </div>
                        </div>
                    </form>
                </div>
