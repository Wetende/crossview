    ...
    <div class="footer-columns">
      <div class="row y-gap-30">
        ...
        <div class="col-xl-4 col-lg-8">
          <div class="text-17 fw-500 text-white uppercase mb-25">SUBJECTS</div>
          <div class="row justify-between y-gap-20">
            <div class="col-md-6">
              <div class="d-flex y-gap-10 flex-column">
                <a href="courses-single-1.html">English</a>
                <a href="courses-single-2.html">Mathematics</a>
                <a href="courses-single-3.html">Physics</a>
                <a href="courses-single-4.html">Chemistry</a>
                <a href="courses-single-5.html">Biology</a>
                <a href="courses-single-6.html">History</a>
                <a href="courses-single-1.html">Geography</a>
                <a href="courses-single-2.html">Kiswahili</a>
                <a href="courses-single-3.html">French</a>
                <a href="courses-single-4.html">Literature</a>
              </div>
            </div>

            <div class="col-md-6">
              <div class="d-flex y-gap-10 flex-column">
                <a href="courses-single-1.html">Commerce</a>
                <a href="courses-single-2.html">Entrepreneurship</a>
                <a href="courses-single-3.html">Computer Studies</a>
                <a href="courses-single-4.html">Agriculture</a>
                <a href="courses-single-5.html">Art</a>
                <a href="courses-single-6.html">Music</a>
                <a href="courses-single-1.html">Home Economics</a>
                <a href="courses-single-2.html">Woodwork</a>
                <a href="courses-single-3.html">Metalwork</a>
                <a href="courses-single-4.html">Physical Education</a>
              </div>
            </div>
          </div>
        </div>
