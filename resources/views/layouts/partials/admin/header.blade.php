                  ...
                  <div class="dropdown bg-transparent px-0 py-0">
                    ...
                    <div class="dropdown__item -dark-bg-dark-2 -dark-border-white-10">
                      <div class="text-14 y-gap-15">
                        ...
                        <div><a href="{{ route('admin.overview') }}" class="d-block text-dark-1">Dashboard</a></div>
                        <div><a href="{{ route('admin.courses.index') }}" class="d-block text-dark-1">@lmsterm('Study Material') Management</a></div>
                        <div><a href="{{ route('admin.course-creation.create') }}" class="d-block text-dark-1">Create @lmsterm('Study Material')</a></div>
                        <div><a href="{{ route('admin.users.index') }}" class="d-block text-dark-1">User Management</a></div>
                        <div><a href="{{ route('admin.settings.index') }}" class="d-block text-dark-1">Settings</a></div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="toggle-element js-courses-toggle">
                      <div class="toggle-bottom -courses bg-white -dark-bg-dark-1 shadow-4 border-light rounded-8 mt-20">
                        <div class="px-30 py-30">
                          ...
                          <div class="mt-20">
                            <a href="{{ route('admin.courses.index') }}" class="button py-20 -dark-1 text-white -dark-bg-purple-1 -dark-border-dark-2 col-12">
                              @lmsterm('Study Material') Management
                            </a>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="px-30 py-30">
                        <div class="sidebar -dashboard">
                          <div class="sidebar__item -is-active -dark-bg-dark-2">
                            <a href="{{ route('admin.overview') }}" class="d-flex items-center text-17 lh-1 fw-500 -dark-text-white">
                              <i class="text-20 icon-discovery mr-15"></i>Dashboard
                            </a>
                          </div>
                          <div class="sidebar__item ">
                            <a href="{{ route('admin.courses.index') }}" class="d-flex items-center text-17 lh-1 fw-500 ">
                              <i class="text-20 icon-play-button mr-15"></i>@lmsterm('Study Material') Management
                            </a>
                          </div>
                          <div class="sidebar__item ">
                            <a href="{{ route('admin.users.index') }}" class="d-flex items-center text-17 lh-1 fw-500 ">
                              <i class="text-20 icon-user-group mr-15"></i>User Management
                            </a>
                          </div>
                          <div class="sidebar__item ">
                            <a href="{{ route('admin.messages.index') }}" class="d-flex items-center text-17 lh-1 fw-500 ">
                              <i class="text-20 icon-message mr-15"></i>Messages
                            </a>
                          </div>
                          <div class="sidebar__item ">
                            <a href="{{ route('admin.settings.index') }}" class="d-flex items-center text-17 lh-1 fw-500 ">
