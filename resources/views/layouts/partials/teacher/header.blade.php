                  ...
                  <div class="dropdown bg-transparent px-0 py-0">
                    ...
                    <div class="dropdown__item -dark-bg-dark-2 -dark-border-white-10">
                      <div class="text-14 y-gap-15">
                        ...
                        <div><a href="{{ route('teacher.overview') }}" class="d-block text-dark-1">Dashboard</a></div>
                        ...
                        <div><a href="{{ route('teacher.settings.profile') }}" class="d-block text-dark-1">Settings</a></div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="toggle-element js-courses-toggle">
                      <div class="toggle-bottom -courses bg-white -dark-bg-dark-1 shadow-4 border-light rounded-8 mt-20">
                        <div class="px-30 py-30">
                          ...
                          <div class="mt-20">
                            <a href="{{ route('teacher.courses.index') }}" class="button py-20 -dark-1 text-white -dark-bg-purple-1 -dark-border-dark-2 col-12">
                      ...
                      <div class="px-30 py-30">
                        <div class="sidebar -dashboard">
                          <div class="sidebar__item -is-active -dark-bg-dark-2">
                            <a href="{{ route('teacher.overview') }}" class="d-flex items-center text-17 lh-1 fw-500 -dark-text-white">
                              <i class="text-20 icon-discovery mr-15"></i>Dashboard
                            </a>
                          </div>
                          <div class="sidebar__item ">
                            <a href="{{ route('teacher.courses.index') }}" class="d-flex items-center text-17 lh-1 fw-500 ">
                              <i class="text-20 icon-play-button mr-15"></i>My @lmsterm('Study Materials')
                            </a>
                          </div>
                          <div class="sidebar__item ">
                            <a href="{{ route('teacher.messages.index') }}" class="d-flex items-center text-17 lh-1 fw-500 ">
                          ...
                          <div class="sidebar__item ">
                            <a href="{{ route('teacher.courses.create') }}" class="d-flex items-center text-17 lh-1 fw-500 ">
                              <i class="text-20 icon-list mr-15"></i>Create @lmsterm('Study Material')
                            </a>
                          </div>
                          <div class="sidebar__item ">
                          ...
                          <div class="sidebar__item ">
                            <a href="{{ route('teacher.settings.profile') }}" class="d-flex items-center text-17 lh-1 fw-500 ">
