...
- [x] 1. Set up database schema and models
  ...
  - [x] 1.2 Create Django migration for parsed_images table
...
- [x] 2. Implement PDF extraction
  ...
  - [x] 2.3 Create ExtractedContent dataclass
  ...
  - [x] 2.5 Write property test for processing report accuracy
...
- [x] 4. Implement session generation

  - [x] 4.1 Create SessionGenerator service
  ...
  - [x] 4.3 Write property test for auto-detection
    - **Property 4: Auto-Detection Creates Sessions**
    - **Validates: Requirements 2.2**

  - [x] 4.4 Write property test for session title generation
    - **Property 5: Session Title Generation**
    - **Validates: Requirements 2.3**

- [x] 5. Implement content optimization

  - [x] 5.1 Install Pillow dependency
    - Add to requirements.txt
    - _Requirements: 3.2_

  - [x] 5.2 Create ContentOptimizer service
  ...
  - [x] 5.4 Write property test for image optimization
    - **Property 7: Image Optimization**
    - **Validates: Requirements 3.2**

  - [x] 5.5 Write property test for large content pagination
...
- [x] 8. Implement versioning
  ...
  - [x] 8.2 Implement version retrieval
    - Return all versions for a node
    - _Requirements: 5.2_

  - [x] 8.3 Write property test for version creation and retrieval
    - **Property 11: Version Creation and Retrieval**
    - **Validates: Requirements 5.1, 5.2**

  - [x] 8.4 Implement version publishing
    - Set is_published flag
    - Make published version active for students
    - _Requirements: 5.3_

  - [x] 8.5 Write property test for version publishing
